package com.hepaestus.testappone.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hepaestus.testappone.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hepaestus.testappone.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.hepaestus.testappone.domain.User.class.getName());
            createCache(cm, com.hepaestus.testappone.domain.Authority.class.getName());
            createCache(cm, com.hepaestus.testappone.domain.User.class.getName() + ".authorities");
